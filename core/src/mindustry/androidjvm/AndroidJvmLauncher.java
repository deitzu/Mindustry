...
public class AndroidJvmLauncher extends ClientLauncher{
    public static void main(String[] arg){
        // Force Android detection in Arc before any Arc classes are initialized
        System.setProperty("arc.android", "true");
        ...
        try{
            ...
            new AndroidJvmSdlApplication(new AndroidJvmLauncher(arg), new SdlConfig(){{
                title = "Mindustry";
                maximized = true;
                coreProfile = true;
                width = 900;
